...
<section class="section menu overflow-visible">
    <div class="navigation-mob d-lg-none position-sticky top-0">
        <div class="menu-content__breadcrumb d-lg-none">
            <?= get_the_title($post); ?>
            /
        ...
        <div class="swiper child-swiper p-3">
            <ul class="swiper-wrapper">
                <?php foreach ($menu_items_hierarchy as $parent_category) : ?>
    ...
    <div class="container">
        <div class="d-lg-flex align-items-lg-start menu-wrapper">
            ...
            <div class="menu-content d-flex flex-column flex-grow-1">
                <div class="menu-content__breadcrumb d-none d-lg-block">
                    <?= get_the_title($post); ?>
                    /
                    <?= translate_and_output('menu'); ?>
                    /
