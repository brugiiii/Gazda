...
<section class="mx-auto position-relative shop">
    <div class="container d-flex flex-column flex-md-row">
        ...
        <div class="shop-content align-self-md-center mx-auto mx-md-0 p-lg-0">
            ...
            <a href="<?= $current_lang === 'uk' ? get_permalink( woocommerce_get_page_id( 'shop' ) ) : get_permalink(6386); ?>" class="shop-button button-secondary d-flex align-items-center justify-content-center gap-2">
