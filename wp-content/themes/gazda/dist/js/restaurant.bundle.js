...
/***/ "./assets/js/restaurant/restaurantMenu.js":
/*!************************************************!*\
  !*** ./assets/js/restaurant/restaurantMenu.js ***!
  \************************************************/
...
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./swiper */ "./assets/js/restaurant/swiper.js");
...
$('#restaurant .nav-list').on('click', 'button', function () {
  ...
  var otherButtons = listItem.siblings().find('button');
...
var sections = $('section.products');
var links = $('#restaurant .nav-list a');
var menuItem = $('#restaurant .menu-item');
var handleSubMenu = function handleSubMenu(link) {
  try {
    var subMenu = link.closest('.sub-menu');
    var listItem = subMenu.closest('li');
    var thisButton = listItem.find('button');
    var otherButtons = listItem.siblings().find('button');
    ...
    var categorySlug = link.attr('href').replace(/^#/, '');
    var childActiveSlide = $(".child-swiper li[data-category-slug=\"".concat(categorySlug, "\"]"));
    var childActiveSlideIndex = parseInt(childActiveSlide.attr('aria-label').split(' / ')[0], 10);
    childActiveSlide.addClass('is-active');
    childActiveSlide.siblings().removeClass('is-active');
    var parentId = childActiveSlide.data('parent-id');
    var parentActiveSlide = $(".parent-swiper .swiper-slide[data-id=\"".concat(parentId, "\"]"));
    var parentActiveSlideIndex = parseInt(parentActiveSlide.attr('aria-label').split(' / ')[0], 10);
    parentActiveSlide.addClass('is-active');
    parentActiveSlide.siblings().removeClass('is-active');
    _swiper__WEBPACK_IMPORTED_MODULE_5__.childSwiper.slideTo(childActiveSlideIndex - 1, 300);
    _swiper__WEBPACK_IMPORTED_MODULE_5__.parentSwiper.slideTo(parentActiveSlideIndex - 1, 300);
  } catch (error) {}
};
...
$(window).on('scroll', lodash_throttle__WEBPACK_IMPORTED_MODULE_4___default()(handleScroll, 100));
$('.parent-swiper').on('click', '.swiper-slide', function () {
  var $this = $(this);
  var categoryId = $this.data('id');
  var childSwiperActiveLink = $(".child-swiper .swiper-slide[data-parent-id=\"".concat(categoryId, "\"] a"))[0];
  childSwiperActiveLink.click();
});

/***/ }),

/***/ "./assets/js/restaurant/swiper.js":
/*!****************************************!*\
  !*** ./assets/js/restaurant/swiper.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   childSwiper: function() { return /* binding */ childSwiper; },
/* harmony export */   parentSwiper: function() { return /* binding */ parentSwiper; }
/* harmony export */ });
/* harmony import */ var swiper_bundle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper/bundle */ "./node_modules/swiper/swiper-bundle.mjs");

var parentSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.parent-swiper', {
  slidesPerView: "auto",
  spaceBetween: 16,
  allowTouchMove: true,
  slideToClickedSlide: true
});
var childSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.child-swiper', {
  slidesPerView: "auto",
  spaceBetween: 10,
  allowTouchMove: true,
  slideToClickedSlide: true
...
/***/ "./assets/js/restaurant/wishlist.js":
/*!******************************************!*\
  !*** ./assets/js/restaurant/wishlist.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var wishlistCount = $('.wishlist-link__count');
$(document.body).on('added_to_wishlist removed_from_wishlist', function () {
  $.ajax({
    ...
    success: function success(response) {
      var count = JSON.parse(response).wishlist_count;
