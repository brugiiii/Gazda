...
/* harmony import */ var _main_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../main/utils */ "./assets/js/main/utils.js");
...
var submitForm = _main_refs__WEBPACK_IMPORTED_MODULE_11__["default"].submitForm;
var url = settings.cta_url;
var ajax_url = "".concat(url, "/crm.lead.add.json");
var handleFormSubmit = function handleFormSubmit(e) {
  ...
  formInputs.each(function () {
    ...
    if (fieldTitle && value) {
      var fieldTitles = fieldTitle.split(" ");
      fieldTitles.forEach(function (title) {
        if (title.toUpperCase() == "EMAIL" || title.toUpperCase() == "PHONE") {
          var value_type = fieldTitle.split(" ").slice(fieldTitle.indexOf(title) + 1, fieldTitle.length).join(" ");
          if (!formData[title.toUpperCase()]) formData[title.toUpperCase()] = [];
          formData[title.toUpperCase()].push({
            VALUE: value,
            VALUE_TYPE: value_type || "WORK"
          });
        } else if (title.toUpperCase() === "SELECT") {
          var selectFieldId = fieldTitles[1];
          formData[selectFieldId] = fieldsID[value];
        } else {
          var _selectFieldId = fieldTitles[1];
          if (!formData[_selectFieldId]) {
  ...
  $.ajax({
    ...
    success: function success(res) {
      ...
      if (res.result) {
        ...
        (0,_main_utils__WEBPACK_IMPORTED_MODULE_12__.showToastMessage)("Lead created successfully", "success");
      } else {
        (0,_main_utils__WEBPACK_IMPORTED_MODULE_12__.showToastMessage)("Error creating lead: " + res.error_description, "error");
      }
    },
    error: function error(_error) {
      formButton.attr("disabled", false); // Re-enable the button on error
      console.error("Error submitting form", _error);
      (0,_main_utils__WEBPACK_IMPORTED_MODULE_12__.showToastMessage)("Error submitting form", "error");
    }
  });
};
...
/* harmony import */ var _event_swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./event/swiper */ "./assets/js/event/swiper.js");
/* harmony import */ var _event_formSubmit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./event/formSubmit */ "./assets/js/event/formSubmit.js");
/* harmony import */ var _css_event_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../css/event.scss */ "./assets/css/event.scss");
