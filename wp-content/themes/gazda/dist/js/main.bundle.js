...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./refs */ "./assets/js/main/refs.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils */ "./assets/js/main/utils.js");
...
var registerForm = _refs__WEBPACK_IMPORTED_MODULE_9__["default"].registerForm,
  loginForm = _refs__WEBPACK_IMPORTED_MODULE_9__["default"].loginForm,
  authModal = _refs__WEBPACK_IMPORTED_MODULE_9__["default"].authModal,
  formSwitcher = _refs__WEBPACK_IMPORTED_MODULE_9__["default"].formSwitcher;
var _settings = settings,
  account_page_link = _settings.account_page_link,
  ajax_url = _settings.ajax_url;
var handleRegisterFormSubmit = function handleRegisterFormSubmit(e) {
  e.preventDefault();
  var form = e.target;
  ...
  var formButton = $(form).find('.auth-form__button');
  ...
  $.ajax({
    ...
    success: function success(res) {
      ...
      if (res.success) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_10__.showToastMessage)(res.data, "success");
        window.location.href = account_page_link;
      } else {
        (0,_utils__WEBPACK_IMPORTED_MODULE_10__.showToastMessage)(res.data, "error");
      }
    },
...
var handleLoginFormSubmit = function handleLoginFormSubmit(e) {
  ...
  var form = e.target;
  var formData = new FormData(form);
  var login_or_email = formData.get('login_or_email');
  var password = formData.get('password');
  var query = {
  ...
  $.ajax({
    ...
    error: function error(_error2) {
      return console.log("error: ", _error2);
    }
  });
};
formSwitcher.on('click', function () {
  return authModal.toggleClass('login-form');
});
...
var burgerMenu = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].burgerMenu,
  burgerButton = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].burgerButton,
  burgerLinks = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].burgerLinks,
  searchForm = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].searchForm,
  headerSearch = _refs__WEBPACK_IMPORTED_MODULE_3__["default"].headerSearch;
var _settings = settings,
...
var handleBurgerLinkClick = function handleBurgerLinkClick(e) {
  ...
  var activeOtherBurgerLink = burgerLinks.not($this).filter('.is-active');
  activeOtherBurgerLink.find('.sub-menu').slideToggle();
  activeOtherBurgerLink.removeClass('is-active');
  subMenu.slideToggle();
  $this.toggleClass("is-active");
};
burgerButton.on("click", lodash_throttle__WEBPACK_IMPORTED_MODULE_4___default()(handleBurgerClick, 500));
burgerLinks.on("click", handleBurgerLinkClick);

/***/ }),

/***/ "./assets/js/main/cart.js":
/*!********************************!*\
  !*** ./assets/js/main/cart.js ***!
  \********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _refs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./refs */ "./assets/js/main/refs.js");
...
var cartModal = _refs__WEBPACK_IMPORTED_MODULE_10__["default"].cartModal,
  cartContent = _refs__WEBPACK_IMPORTED_MODULE_10__["default"].cartContent;
var _settings = settings,
  ajax_url = _settings.ajax_url;
var timeout;
function handleQuantity(e) {
  var $this = $(e.currentTarget);
  var quantityWrapper = $this.closest(".cart-quantity");
  var quantityValueEl = quantityWrapper.find(".cart-quantity__value");
  var quantityValue = Number(quantityValueEl.text());
  if (quantityValue === 1 && $this.hasClass('decrement')) return;
  clearTimeout(timeout);
  var delta = $this.hasClass('increment') ? 1 : -1;
  var quantity = quantityValue + delta;
  quantityValueEl.text(quantity);
  var productItem = quantityWrapper.closest(".cart-products__item");
  var _productItem$data = productItem.data(),
    productId = _productItem$data.productId;
...
function updateQuantity(productId, quantity) {
  ...
  $.ajax({
    ...
    success: function success(_ref) {
      var cartMarkup = _ref.data.cartMarkup,
...
function handleRemove(e) {
  var $this = $(e.currentTarget);
  var productItem = $this.closest(".cart-products__item");
  var _productItem$data2 = productItem.data(),
    productId = _productItem$data2.productId;
...
function removeProduct(productId) {
  ...
  $.ajax({
    ...
    success: function success(_ref2) {
      var cartMarkup = _ref2.data.cartMarkup,
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./assets/js/main/utils.js");


var authBackdrop = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].authBackdrop,
  authButton = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].authButton,
  cartBackdrop = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].cartBackdrop,
  cartButton = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].cartButton,
  hideCartButton = _refs__WEBPACK_IMPORTED_MODULE_0__["default"].hideCartButton;
authButton.on('click', function () {
  return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showBackdrop)(authBackdrop);
});
cartButton.on('click', function () {
  return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.showBackdrop)(cartBackdrop);
});
hideCartButton.on("click", function () {
  return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.hideBackdrop)(cartBackdrop);
});
...
/* harmony import */ var _helpers_productsSkeleton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/productsSkeleton */ "./assets/js/helpers/productsSkeleton.js");
/* harmony import */ var _shop_productFunctions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../shop/productFunctions */ "./assets/js/shop/productFunctions.js");




var headerSearch = _refs__WEBPACK_IMPORTED_MODULE_1__["default"].headerSearch,
  searchForm = _refs__WEBPACK_IMPORTED_MODULE_1__["default"].searchForm,
...
var fetchProducts = function fetchProducts() {
  ...
  var skeleton = (0,_helpers_productsSkeleton__WEBPACK_IMPORTED_MODULE_2__.productsSkeleton)(skeletonCount);
  if (useSkeleton) {
  ...
  $.ajax({
    ...
    data: query,
    success: function success(res) {
      return (0,_shop_productFunctions__WEBPACK_IMPORTED_MODULE_3__.handleProductsFetchSuccess)(res, query);
    },
    error: function error(_error) {
...
searchInput.on('input', lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(handleInput, 700));
orderButtons.on("click", function (e) {
  return (0,_shop_productFunctions__WEBPACK_IMPORTED_MODULE_3__.handleOrderButtonClick)(e, query, fetchProducts);
});
orderSelect.on('change', function (e) {
  return (0,_shop_productFunctions__WEBPACK_IMPORTED_MODULE_3__.handleOrderSelectChange)(e, query, fetchProducts);
});
productsItems.on("click", '.pagination__item, .load-more', function (e) {
  return (0,_shop_productFunctions__WEBPACK_IMPORTED_MODULE_3__.handlePaginationClick)(e, query, utils, fetchProducts);
});
$(document).ready(function () {
...
function disableBodyScroll() {
  var scrollbarWidth = window.innerWidth - document.body.getBoundingClientRect().width;
  bodyEl.css({
    "overflow-y": "hidden",
    "touch-action": "none",
...
/* harmony import */ var _main_cart__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./main/cart */ "./assets/js/main/cart.js");
...
/* harmony import */ var _css_main_scss__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../css/main.scss */ "./assets/css/main.scss");
