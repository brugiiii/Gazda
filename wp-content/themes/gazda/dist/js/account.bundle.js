...
/***/ "./assets/js/account/contentVisibility.js":
/*!************************************************!*\
  !*** ./assets/js/account/contentVisibility.js ***!
  \************************************************/
...
var accountNav = _main_refs__WEBPACK_IMPORTED_MODULE_0__["default"].accountNav;
var handleNavClick = function handleNavClick(e) {
  var $this = $(e.currentTarget);
  if ($this.hasClass('is-active')) return;
  var previousActiveButton = $('.nav-list__button.is-active');
  var data = $this.data('content');
  var previousActiveSectionItem = $('.section__item:visible');
  var activeSectionItem = $(".section__item[data-content=\"".concat(data, "\"]"));
...
/***/ "./assets/js/account/formSubmit.js":
/*!*****************************************!*\
  !*** ./assets/js/account/formSubmit.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _main_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../main/utils */ "./assets/js/main/utils.js");
...
var personalForm = _main_refs__WEBPACK_IMPORTED_MODULE_9__["default"].personalForm,
  passwordForm = _main_refs__WEBPACK_IMPORTED_MODULE_9__["default"].passwordForm;
var _settings = settings,
  ajax_url = _settings.ajax_url;
var handlePersonalFormSubmit = function handlePersonalFormSubmit(e) {
  e.preventDefault();
  ...
  $.ajax({
    ...
    success: function success(res) {
      ...
      if (res.success) {
        (0,_main_utils__WEBPACK_IMPORTED_MODULE_10__.showToastMessage)(res.data, "success");
      } else {
        (0,_main_utils__WEBPACK_IMPORTED_MODULE_10__.showToastMessage)(res.data, "error");
      }
    },
...
var handlePasswordFormSubmit = function handlePasswordFormSubmit(e) {
  e.preventDefault();
  var form = e.currentTarget;
  var formData = new FormData(form);
  var oldPassword = formData.get('old-password');
  var newPassword = formData.get('new-password');
  var repeatNewPassword = formData.get('repeat-new-password');
  if (newPassword !== repeatNewPassword) return (0,_main_utils__WEBPACK_IMPORTED_MODULE_10__.showToastMessage)("Паролі не співпадають. Будь ласка, спробуйте ще раз.", "error");
  var query = {
...
/***/ "./assets/js/account/getOrderInfo.js":
/*!*******************************************!*\
  !*** ./assets/js/account/getOrderInfo.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _main_refs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../main/refs */ "./assets/js/main/refs.js");
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./swiper */ "./assets/js/account/swiper.js");
var _this = undefined;


var orderListButtons = _main_refs__WEBPACK_IMPORTED_MODULE_0__["default"].orderListButtons,
  orderInfoWrapper = _main_refs__WEBPACK_IMPORTED_MODULE_0__["default"].orderInfoWrapper;
var _settings = settings,
  ajax_url = _settings.ajax_url;
var handleOrderButtonClick = function handleOrderButtonClick(e) {
  var $this = $(e.currentTarget);
  console.log(_this);
  if ($this.hasClass('is-active')) return _swiper__WEBPACK_IMPORTED_MODULE_1__.ordersSwiper.slideTo(1);
  var previousActiveButton = $('.orders-list__button.is-active');
  var orderId = $this.data('order-id');
  var parentWrapper = $this.closest('.orders-list__item');
  ...
  $.ajax({
    ...
    success: function success(res) {
      ...
      _swiper__WEBPACK_IMPORTED_MODULE_1__.ordersSwiper.slideTo(1);
    },
    error: function error(_error) {
      return console.log("error: ", _error);
    }
...
/***/ "./assets/js/account/inputType.js":
/*!****************************************!*\
  !*** ./assets/js/account/inputType.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var passVisibilityButton = _main_refs__WEBPACK_IMPORTED_MODULE_0__["default"].passVisibilityButton;
var handlePassVisiblityButtonClick = function handlePassVisiblityButtonClick(e) {
  var $this = $(e.currentTarget);
...
/* harmony export */   ordersSwiper: function() { return /* binding */ ordersSwiper; }
/* harmony export */ });
/* harmony import */ var swiper_bundle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper/bundle */ "./node_modules/swiper/swiper-bundle.mjs");

var ordersSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".orders-swiper", {
  slidesPerView: 1,
  spaceBetween: 16,
  navigation: {
...
/* harmony import */ var _account_contentVisibility__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./account/contentVisibility */ "./assets/js/account/contentVisibility.js");
/* harmony import */ var _account_formSubmit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./account/formSubmit */ "./assets/js/account/formSubmit.js");
/* harmony import */ var _account_inputType__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./account/inputType */ "./assets/js/account/inputType.js");
/* harmony import */ var _account_swiper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./account/swiper */ "./assets/js/account/swiper.js");
/* harmony import */ var _account_getOrderInfo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./account/getOrderInfo */ "./assets/js/account/getOrderInfo.js");
/* harmony import */ var _css_account_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../css/account.scss */ "./assets/css/account.scss");
