<?php
if (isset($_POST['categories']) && isset($_POST['page'])) {
    ...
    if ($query->have_posts()) {
        ...
        <ul class="products-list d-flex flex-wrap">
            ...
            while ($query->have_posts()) {
                ...
                ?>
                <li class="products-list__item position-relative col-lg-3">
                    <div class="product-list__wrapper bg-white position-absolute top-0 start-0 rounded-3 overflow-hidden d-flex flex-column w-100">
                        ...
                        <div class="product-list__details px-3 pb-3 pt-2 flex-grow-1">
                            ...
                            <button class="product-list__button button-primary w-100 border-0 d-flex align-items-center justify-content-center gap-2" data-product-id="<?= get_the_ID(); ?>">
