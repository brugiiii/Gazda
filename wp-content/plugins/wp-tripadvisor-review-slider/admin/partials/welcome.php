...
<a id="provimg" href="https://wpreviewslider.com/" target="_blank"><img class="wprev_wpproimg" src="<?php echo plugin_dir_url( __FILE__ ) . 'sitelogo4.png?v='.$this->version; ?>"></a>
	...
	<li>Download all your TripAdvisor reviews from multiple locations plus images! </li>
...
<div class="w3_wprs-row">
    ...
    text-decoration: none;
							...
							<div class="w3_wprs-col s4">
							  <div class="w3_wprs-col">							
							  <div class="wptripadvisor_t1_DIV_1">									
							  <div class="wptripadvisor_t1_DIV_2 wprev_preview_bg1 wprev_preview_bradius" style="border-radius: 0px; background: rgb(253, 253, 253);">										<p class="wptripadvisor_t1_P_3 wprev_preview_tcolor1" style="color: rgb(85, 85, 85);">											<span class="wptripadvisor_star_imgs"><img src="https://ljapps.com/wp-content/plugins/wp-review-slider-pro-premium/public/partials/imgs/stars_5_yellow.png" alt="">&nbsp;&nbsp;</span>Great product, great support! Love this product and the support received has been amazing and fast.</p>									</div><span class="wptripadvisor_t1_A_8"><img src="https://wpreviewslider.com/wp-content/uploads/wprevslider/avatars/1633774408_188.jpg" alt="thumb" class="wptripadvisor_t1_IMG_4"></span> <span class="wptripadvisor_t1_SPAN_5 wprev_preview_tcolor2" style="color: rgb(85, 85, 85);">Russ Kemp<br>Owner, <a href="https://www.russkempphotography.com" target="_blank">Russ Kemp Photography </a></span>								</div>								
							  </div>
							</div>
						  <div class="w3_wprs-col s4">
							  <div class="w3_wprs-col">							
							  <div class="wptripadvisor_t1_DIV_1">
							  <div class="wptripadvisor_t1_DIV_2 wprev_preview_bg1 wprev_preview_bradius" style="border-radius: 0px; background: rgb(253, 253, 253);">										<p class="wptripadvisor_t1_P_3 wprev_preview_tcolor1" style="color: rgb(85, 85, 85);">											<span class="wptripadvisor_star_imgs"><img src="https://ljapps.com/wp-content/plugins/wp-review-slider-pro-premium/public/partials/imgs/stars_5_yellow.png" alt="">&nbsp;&nbsp;</span><b>Wow this thing really works!</b> I’m really happy with this plug-in. It’s doing exactly what it supposed to do. I even need a little bit of help and got it quickly. Highly recommend!		</p>									</div><span class="wptripadvisor_t1_A_8"><img src="https://wpreviewslider.com/wp-content/uploads/wprevslider/avatars/1649464747_442.jpg" alt="thumb" class="wptripadvisor_t1_IMG_4"></span> <span class="wptripadvisor_t1_SPAN_5 wprev_preview_tcolor2" style="color: rgb(85, 85, 85);">Andrea Barnes<br>Developer, <a href="https://websitessandiego.com" target="_blank">Websites San Diego </a> </span>								</div>								
							  </div>
						  </div>
					</div>
<br>
<a href="https://wpreviewslider.com/pricing/#customerfeedback" target="_blank" class="w3-button w3-round w3-border w3-greentrip w3-margin-bottom w3-margin-top"><?php _e('Read More Pro Version Feedback Here', 'wp-tripadvisor-review-slider'); ?></a>
