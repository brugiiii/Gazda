...
<tr class="wptripadvisor_row">
			...
			<tr class="wprevpro_row">
				...
				<td><div class="">
					<label for="wprevpro_t_showmedia"><?php _e('Display Review Media:', 'wp-tripadvisor-review-slider'); ?></label>
					...
					<p class="description">
					<?php _e('Show images that users have added with their review.', 'wp-tripadvisor-review-slider'); ?></p>
				</td>
			</tr>
