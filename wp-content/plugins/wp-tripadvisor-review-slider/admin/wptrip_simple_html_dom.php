	...
	$defaultSpanText = DEFAULT_SPAN_TEXT)
{
	...
	$dom = new wptrip_simple_html_dom(
		null,
		$lowercase,
		$forceTagsClosed,
		$target_charset,
	...
	$defaultSpanText = DEFAULT_SPAN_TEXT)
{
	...
	//echo "<br>here:".strlen($str);
	//echo "<br>max:".MAX_FILE_SIZE;
	$dom = new wptrip_simple_html_dom(
		null,
		$lowercase,
		$forceTagsClosed,
...
class wptrip_simple_html_dom
{
	...
	{
		return @wptrip_str_get_html("<$name>$value</$name>")->firstChild();
	}

	function createTextNode($value)
	{
		return @end(wptrip_str_get_html($value)->nodes);
	}
