...
<div class="wptripadvisor_t1_outer_div_widget w3_wprs-row-padding-small">
    ...
    <div class="swiper reviews-swiper">
        <div class="swiper-wrapper wptripadvisor_t1_outer_div w3_wprs-row-padding">
            <?php
            }
            //loop
            foreach ($rowarray[$x] as $review) {
                ...
                if ($review->userpic == '' || !$review->userpic) {
                    ...
                    $userpichtml = '<img src="' . $userpic . '" alt="avatar thumb" class="wptripadvisor_t1_IMG_4" loading="lazy"/>';
                }
                ...
                if ($review->type == "TripAdvisor") {
                    ...
                    $starfile = "tripadvisor_stars_" . $review->rating . ".webp";
                ...
                if ($review->review_text != "") {
                    ...
                    $morelink = '<a href="' . $burl . '" class="ta_morelink" target="_blank" rel="nofollow">' . __('..More', 'wp-tripadvisor-review-slider') . '</a>';
                ...
                if ($currentform[0]->read_more != "no") {
                    ...
                    if ($countwords > $readmorenum) {
                        ...
                        $reviewtext = implode(" ", $part1) . "<a class='wprs_rd_more'>... <span>" . $currentform[0]->read_more_text . "</span></a><span class='wprs_rd_more_text' style='display:none;'> " . implode(" ", $part2) . "</span>";
                    }
                }
                ...
                if(	$currentform[0]->read_more=="yes"){
                    ...
                    if($countwords>$readmorenum){
                        ...
                        $reviewtext = $part1."<a class='wprs_rd_more'>".__('... read more', 'wp-tripadvisor-review-slider')."</a><span class='wprs_rd_more_text' style='display:none;'> ".$part2."</span>";
                ...
                */
                ...
                if ($review->review_title != "") {
                    $titlehtml = '<span class="wprevrevtitle">' . $review->review_title . '</span>&nbsp;-&nbsp;';
                }
                $verifiedhtml = '&nbsp;&nbsp;';
                ...
                ?>
                <div class="swiper-slide wptripadvisor_t1_DIV_1<?php if ($currentform[0]->template_type == "widget") {
                    echo ' marginb10';
                } ?> w3_wprs-col l<?php echo $perrow; ?>">
                    <div class="wptripadvisor_t1_DIV_2 wprev_preview_bg1_T<?php echo $currentform[0]->style; ?><?php if ($iswidget) {
                        echo "_widget";
                    } ?> wprev_preview_bradius_T<?php echo $currentform[0]->style; ?><?php if ($iswidget) {
                        echo "_widget";
                    } ?>">
                        <div class="wptripadvisor_star_imgs_T<?php echo $currentform[0]->style; ?><?php if ($iswidget) {
                            echo "_widget";
                        } ?>"><img src="<?php echo $imgs_url . "" . $starfile; ?>" alt="star rating"
                                   class="wptripadvisor_t1_star_img_file"></div>
                        <p class="wptripadvisor_t1_P_3 wprev_preview_tcolor1_T<?php echo $currentform[0]->style; ?><?php if ($iswidget) {
                            echo "_widget";
                        } ?>">
                            <?php echo stripslashes($reviewtext); ?>
                        </p>

                        <span class="wptripadvisor_t1_SPAN_5 wprev_preview_tcolor2_T<?php echo $currentform[0]->style; ?><?php if ($iswidget) {
                            echo "_widget";
                        } ?>"><?php echo stripslashes($review->reviewer_name); ?><span
                                    class="wprev_showdate_T<?php echo $currentform[0]->style; ?><?php if ($iswidget) {
                                        echo "_widget";
